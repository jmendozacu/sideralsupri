...
document.observe("dom:loaded", function() {
    ...
    var loadMore = Class.create({
        initialize: function (list, href, pattern) {
            ...
            this.list = list;
            this.list.insert({ after : '<div class="more"><span id="more_button" class="more-button">Ver mais</span></div>'});
            ...
            sliderLink.observe('click', function(e) {
                ...
                if (!this.clonedSubmenuList.firstDescendant().hasClassName('subcategory-header')) {
                    ...
                    subcategoryHeader.insert({
                        top: new Element('button', {'class': 'previous-category'}).update("Voltar").wrap('div', {'class':'button-wrap'}),
                        bottom: this.innerHTML
                    });
                    this.clonedSubmenuList.insert({
                        top: subcategoryHeader
                    });
                    subcategoryHeader.insert({ after : new Element('li').update('<a href="' + sliderLink.href + '"><span>Todos os produtos</span></a>') });
