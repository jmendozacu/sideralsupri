...
class Mage_Payment_Block_Info_Checkmo014 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo014.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo014.phtml');
        return $this->toHtml();
    }
