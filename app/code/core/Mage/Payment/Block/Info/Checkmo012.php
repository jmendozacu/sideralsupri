...
class Mage_Payment_Block_Info_Checkmo012 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo012.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo012.phtml');
        return $this->toHtml();
    }
