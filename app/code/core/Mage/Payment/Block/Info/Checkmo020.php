...
class Mage_Payment_Block_Info_Checkmo020 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo020.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo020.phtml');
        return $this->toHtml();
    }
