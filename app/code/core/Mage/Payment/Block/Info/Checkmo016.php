...
class Mage_Payment_Block_Info_Checkmo016 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo016.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo016.phtml');
        return $this->toHtml();
    }
