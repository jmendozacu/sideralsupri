...
class Mage_Payment_Block_Info_Checkmo007 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo007.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo007.phtml');
        return $this->toHtml();
    }
