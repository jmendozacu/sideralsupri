...
class Mage_Payment_Block_Info_Checkmo011 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo011.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo011.phtml');
        return $this->toHtml();
    }
