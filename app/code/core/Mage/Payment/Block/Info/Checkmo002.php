...
class Mage_Payment_Block_Info_Checkmo002 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo002.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo002.phtml');
        return $this->toHtml();
    }
