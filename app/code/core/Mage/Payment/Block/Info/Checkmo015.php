...
class Mage_Payment_Block_Info_Checkmo015 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo015.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo015.phtml');
        return $this->toHtml();
    }
