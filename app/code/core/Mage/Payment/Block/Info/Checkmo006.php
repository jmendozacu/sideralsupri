...
class Mage_Payment_Block_Info_Checkmo006 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo006.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo006.phtml');
        return $this->toHtml();
    }
