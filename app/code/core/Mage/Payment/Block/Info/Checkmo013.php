...
class Mage_Payment_Block_Info_Checkmo013 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo013.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo013.phtml');
        return $this->toHtml();
    }
