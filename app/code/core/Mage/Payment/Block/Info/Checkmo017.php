...
class Mage_Payment_Block_Info_Checkmo017 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo017.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo017.phtml');
        return $this->toHtml();
    }
