...
class Mage_Payment_Block_Info_Checkmo008 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo008.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo008.phtml');
        return $this->toHtml();
    }
