...
class Mage_Payment_Block_Info_Checkmo010 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo010.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo010.phtml');
        return $this->toHtml();
    }
