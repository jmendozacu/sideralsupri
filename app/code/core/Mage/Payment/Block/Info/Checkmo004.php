...
class Mage_Payment_Block_Info_Checkmo004 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo004.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo004.phtml');
        return $this->toHtml();
    }
