...
class Mage_Payment_Block_Info_Checkmo018 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo018.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo018.phtml');
        return $this->toHtml();
    }
