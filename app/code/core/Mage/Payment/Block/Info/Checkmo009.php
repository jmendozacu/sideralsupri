...
class Mage_Payment_Block_Info_Checkmo009 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo009.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo009.phtml');
        return $this->toHtml();
    }
