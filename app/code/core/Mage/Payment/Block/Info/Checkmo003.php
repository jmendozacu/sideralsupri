...
class Mage_Payment_Block_Info_Checkmo003 extends Mage_Payment_Block_Info
{
    ...
    {
        parent::_construct();
        $this->setTemplate('payment/info/checkmo003.phtml');
    }
    ...
    {
        $this->setTemplate('payment/info/pdf/checkmo003.phtml');
        return $this->toHtml();
    }
