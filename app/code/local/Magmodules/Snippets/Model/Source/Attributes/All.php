...
class Magmodules_Snippets_Model_Source_Attributes_All {
	...
	public function toOptionArray(){
        ...
        foreach ($attributes as $attribute){
			if(($attribute->getBackendType() == 'text') || ($attribute->getBackendType() == 'varchar') || ($attribute->getBackendType() == 'int') || ($attribute->getBackendType() == 'static')) {
