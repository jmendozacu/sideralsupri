...
class Mageplace_Callforprice_Model_Htmlprocessor_Zendquery_Related
    ...
    implements Mageplace_Callforprice_Model_Processor_Interface
{
    ...
    protected function _process($products)
    {
        ...
        $processor->replace(
            $helper->getCssSelector('related_product_price'),
            $this->_getHelper()->prepareReplacement(),
            $positions,
            $helper->getCssSelector('related_product_cell')
        );
