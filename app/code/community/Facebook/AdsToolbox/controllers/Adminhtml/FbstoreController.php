...
class Facebook_AdsToolbox_Adminhtml_FbstoreController
  ...
  public function ajaxAction() {
    try {
      ...
      $product_count = FacebookAdsToolbox::getTotalVisibleProducts($store_id);
  ...
  private function reportFailure($store_id, $e) {
    ...
    FacebookAdsToolbox::log("Set Store ID Failure : ".$msg." ".$store_id);
