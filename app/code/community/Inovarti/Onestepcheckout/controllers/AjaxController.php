...
class Inovarti_Onestepcheckout_AjaxController extends Mage_Checkout_Controller_Action {
    ...
    public function busca_cepAction() {
        ...
        $webservice = 'https://www.sideralsupri.com.br/consulta_cep.php';
        
        $ch = curl_init();
        curl_setopt ($ch, CURLOPT_URL, $webservice . '?cep=' . urlencode($cep));
        //curl_setopt ($ch, CURLOPT_URL, $webservice . '?cep=' . urlencode($cep) . '&ret=javascript');
