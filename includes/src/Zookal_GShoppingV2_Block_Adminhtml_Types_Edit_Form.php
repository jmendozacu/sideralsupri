 ...
 */
class Zookal_GShoppingV2_Block_Adminhtml_Types_Edit_Form extends Mage_Adminhtml_Block_Widget_Form
{
    /**
     * Prepare form before rendering HTML
     *
     * @return Zookal_GShoppingV2_Block_Adminhtml_Types_Edit_Form
     */
    protected function _prepareForm()
    {
        ...
        $countrySelect = $fieldset->addField('select_target_country', 'select', [
        ...
        $fieldset->addField('attribute_set', 'note', [
        ...
        $attributesBlock = $this->getLayout()
            ->createBlock('gshoppingv2/adminhtml_types_edit_attributes')
        ...
        $fieldset->addField('attributes_box', 'note', [
    ...
    protected function _getAttributeSetsArray($targetCountry)
    {
        ...
        if (!($itemType instanceof Varien_Object && $itemType->getId())) {
            $typesCollection = Mage::getResourceModel('gshoppingv2/type_collection')
    ...
    {
        return $this->getUrl('*/*/save', ['type_id' => $this->getItemType()->getId()]);
    }
}
