 ...
 */
class Zookal_GShoppingV2_Block_Adminhtml_Types_Edit_Attributes
    extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    public function __construct()
    {
        $this->setTemplate('gshoppingv2/types/edit/attributes.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        $this->setChild('add_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData([
                    'label'    => Mage::helper('gshoppingv2')->__('Add New Attribute'),
                    'class'    => 'add',
        ...
        $this->setChild('delete_button',
            $this->getLayout()->createBlock('adminhtml/widget_button')
                ->setData([
                    'label'    => Mage::helper('gshoppingv2')->__('Remove'),
    ...
    {
        $options[] = ['label' => $this->__('Custom attribute, no mapping')];

        $attributesTree = Mage::getSingleton('gshoppingv2/config')
        ...
        $select = $this->getLayout()->createBlock('gshoppingv2/adminhtml_types_edit_select')
    ...
    {
        $attributes = Mage::getModel('gshoppingv2/attribute')->getAllowedAttributes($setId);
        $result     = [];
